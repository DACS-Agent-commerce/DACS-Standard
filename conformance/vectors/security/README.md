...
| [`legacy-agreement-admission-v0.8.json`](legacy-agreement-admission-v0.8.json) | DACS-4 v0.8 §9.5.1 LAA-1..LAA-7; DACS-3 v0.6 §8.6 CA-10 | 156 | `error` / `fail` / `indeterminate` / `pass` |
...
One hundred fifty-six candidate cases execute the governed transition from legacy
...
distinct orchestrator signature when required, and pre-checkpoint receipt bind
