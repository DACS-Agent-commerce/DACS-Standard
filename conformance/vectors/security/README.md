...
| [`reputation-settlement-reference-divergence-v0.3.json`](reputation-settlement-reference-divergence-v0.3.json) | DACS-5 §10.4.3 settlementEvidence reference-multiset divergence + §10.5.1 guard (ii) | 6 | `fail` / `pass` |
| [`reputation-settlement-semantics-v0.3.json`](reputation-settlement-semantics-v0.3.json) | DACS-5 §10.5.1 RSV-1..RSV-4; consumes existing DACS-4 rules | 16 | `accept` / `indeterminate` / `reject` |
...
### `reputation-settlement-reference-divergence-v0.3.json` — §10.4.3 / §10.5.1 guard (ii)

Six candidate vectors pin the cross-copy comparison that precedes RSV. The
...
### `reputation-settlement-semantics-v0.3.json` — §10.5.1 RSV-1..RSV-4

16 candidate vectors for the DACS-4/DACS-5 composition edge: the selected
