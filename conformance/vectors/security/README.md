...
| [`raw-json-profile-v0.1.json`](raw-json-profile-v0.1.json) | CORE §B.2 CF-5 raw JSON admission | 51 | `accept` / `reject` |
...
51 raw UTF-8 JSON cases execute the mandatory admission step that precedes
