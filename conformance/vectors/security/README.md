...
| [`canonical-channel-message-v0.6.json`](canonical-channel-message-v0.6.json) | DACS-3 §8.3.3 CH-6..CH-10 + CORE §B.7 SIG-2/SIG-5/SIG-6 | 46 | `error` / `fail` / `indeterminate` / `pass` |
...
46 deterministic cases for the discriminated current
