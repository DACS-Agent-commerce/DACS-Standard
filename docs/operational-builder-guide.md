...
- For success-outcome payment evidence, populate the v0.1 `settlementFinality`
  record with the finality model and parameters actually applied (PC-6); keep it
  absent from delivery evidence.
