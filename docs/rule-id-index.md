...
| PDE-* | Phase-bound delivery evidence, phase-indexed artifact addresses, exact entitlement-credential delivery binding, legacy reads, and DACS-5 one-to-one mapping | §9.7 / §10.4.3 | §14.4 |
