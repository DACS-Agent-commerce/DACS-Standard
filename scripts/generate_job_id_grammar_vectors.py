...
def build() -> dict:
    ...
    vectors = [
        ...
        ),
        {
            ...
            "note": "An implementation-authenticated peer reference resolves to the exact synthetic release and complete module tuple.",
        ...
        },
        {
            ...
            "note": "A caller-provided reference with no authenticated peer evidence refuses.",
            "want": {"failureStage": "profile-admission", "hashCalls": 0,
                     "lookupCalls": 0},
        },
        {
        ...
        },
        {
            ...
            "operation": "profile-admit",
            "expected": "error",
            "peerProfileRef": "fixture:peer-wrong-pin",
        ...
        },
        {
            ...
            "operation": "profile-admit",
            "expected": "error",
            "peerProfileRef": "fixture:peer-partial-tuple",
        ...
        },
        {
            ...
            "operation": "profile-admit",
            "expected": "error",
            "peerProfileRef": "fixture:peer-extra-tuple",
        ...
        },
        {
            ...
            "operation": "profile-admit",
            "expected": "error",
            "peerProfileRef": "fixture:peer-non-string-pin",
        ...
        },
        {
            ...
            "operation": "profile-admit",
            "expected": "error",
            "peerProfileRef": "fixture:peer-major-only",
    ...
    return {
        ...
        "syntheticProfileAdmissionFixture": {
            ...
            "moduleVersions": CORRECTIVE_TUPLE,
            "peerEvidence": "peerProfileRef is resolved only through implementation-owned authenticated fixture state",
        },
