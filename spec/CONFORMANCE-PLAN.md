...
| SAC-1..SAC-10 | §8.4.4 | demand absent/explicit mode and procurement role direction; exact closed signed bidder record/job/listing/phase/address authority; independently authenticated invocation tuple; SR-2 registry-authenticated definition ref/id/version with definition-derived proof/finality/admission/resource policy; latest-finalized complete prefix at or after the reveal deadline; exact set hash/count/order and every-record accounting; unavailable fact blocks instead of excluding a bidder; listing-derived currency, inclusive reserve, CD-1 lowest/highest-price reproduction and SE-5 tie-break; first-acceptable/rule-ref refused before execution; exact receipt signature/ref/finality; winner/price/role/payout closure into the selection-bound agreement; omitted better reveal, stale set, fork, fully re-signed cross-session artifacts, malformed record, and receipt substitution | `conformance/vectors/security/sealed-auction-completeness-v0.6.json`; `tests/test_sealed_auction_completeness_vectors.py` |
