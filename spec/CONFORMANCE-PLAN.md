...
| PIPE-1..PIPE-6 | §9.9 | ≥1 deliver (pay-* optional, §6.3.4(8)); deterministic ordering; pay↔deliver gating; phase repetition with independent phase-bound payment/delivery evidence; finalized DACS-3 commitment before payment or irreversible delivery | `conformance/vectors/security/sr2-anchor-lifecycle-v0.1.json`; `conformance/vectors/security/phase-bound-delivery-evidence-v0.7.json` |
