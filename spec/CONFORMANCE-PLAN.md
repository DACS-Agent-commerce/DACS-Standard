...
| X402-1..X402-4 | §9.5.7 | v1/v2 response-header selection; full decoded-object JCS hash; JSON/base64 normalization; extensions and unknown members preserved; malformed/non-success refusal; hash and transaction/network mismatch rejection | `conformance/vectors/security/x402-receipt-hash-v0.1.json` |
