...
**Non-signature hash-domain tags.** The table above registers *signature* domain separators (SIG-1 scopes to signatures). Ten further `dacs-*:v1:` tags domain-separate normative hashes that are not signature payloads:
