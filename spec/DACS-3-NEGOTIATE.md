...
type AgreementDocument = {
  ...
  terms: {
    ...
    // non-negative integer count of `unit`s, serialised as the canonical unsigned decimal
    // string "0" or [1-9][0-9]*; terms.price recomputes from it (MTR-4). First-class in terms
    // so JCS places it under every signature and the agreement hash.
