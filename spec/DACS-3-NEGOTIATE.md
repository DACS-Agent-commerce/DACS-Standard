...
type NegotiateSealedEnvelopeInput = {
  ...
  parameters: {
    ...
    auctionMode?: "demand" | "procurement"  // must match the sealed-envelope phase kind; absent defaults to demand only on the demand phase (SE-8)
