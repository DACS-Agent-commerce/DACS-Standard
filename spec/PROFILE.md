...
## Unreleased coordinated corrective candidate — JID-1 and Vet
...
| [DACS-1-IDENTIFY](DACS-1-IDENTIFY.md) | 0.7 | Draft corrective candidate; JID-1 and session presentation behaviour affected |
