...
| Self-declared or unregistered listing rail | malicious counterparty / malicious infrastructure | §6.3.4 LRR-1..LRR-6 (canonical registry resolution, exact version and phase-handler binding, unavailable authority indeterminate, no silent PA-2 fallback) | mitigated |
