...
| Sealed-auction selective discovery / omitted better reveal | malicious orchestrator, seller, indexer, or stale node | §8.4.4 SAC-1..SAC-10 (new-type gate; signed bidder records; authenticated current-finalized complete set; exact record accounting; reproducible receipt bound into co-signed agreement) | mitigated for the complete profile; historical §8.4.3 profile does not claim completeness |
