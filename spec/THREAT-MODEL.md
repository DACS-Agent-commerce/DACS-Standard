...
| Stronger identity-bound agreement relabelled as, or downgraded to, a historical agreement artifact | malicious counterparty / incompatible implementation | CORE §B.2 IBH-1..IBH-6 + DACS-3 §8.5/§8.6 (distinct discriminators, domains, signed phases, authenticated bundle/CVR joins, and exact four-way dispatch at commit/payment/terminal admission) | mitigated; historical agreement bytes and meanings remain valid under both commitment-record forms and are never normalised or re-signed |
