...
| Post-checkpoint legacy production, forged historical role/mapping, or candidate-authorized checkpoint | malicious producer / infrastructure | §10.4 LAB-1..LAB-7 (externally trusted checkpoint discovery; exact original BundleBinding/party-map/budget or pure mapping; finalized receipt joins and strict native ordering before admission) | mitigated for the explicit current-use derivation; unavailable, pruned, reorganized, conflicting, or unorderable authority remains indeterminate |
| Strong reputation request downgraded by discriminator stripping, relabelling, partial-job omission, or claimed-metric replay | malicious producer / compatibility skew | §10.5.1 CUR-1..CUR-8 (exclusive type gate before dereference; closed all-job request; no weaker fallback or partial result; complete dependency replay and full-result equality) | mitigated for the unallocated current-use candidate; existing historical derivations retain their frozen weaker contracts |
