...
| Authentic settlement event on a stale fork or behind attacker-selected/fake confirmation head | malicious counterparty / infrastructure | §9.7.0 FV-1..FV-10 (signed rail profile; network/genesis binding; inclusion; authenticated head/ancestry; computed depth/commitment/BFT quorum; four-value reorg handling) | mitigated for finality-bound evidence; historical evidence remains profile-dependent |
