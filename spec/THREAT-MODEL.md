...
| Rail availability-field poisoning, mocked production selection, or stale discovery-hint override | malicious infrastructure / misconfigured operator | §6.3.4 LRR-6 + §9.4.4 RAV-R1..RAV-R5 (disabled/failed new-session prohibition; mocked production-session prohibition; disabled in-flight distinction; signed pinned availability authority; hints are non-authoritative) | mitigated |
