...
| Invalid or unavailable finality hidden by an outer bundle or weaker copy | malicious producer / compatibility skew | §10.4.1–§10.4.3 distinct finality-bound bundle/pointer domain; role/job authentication before precedence; required strong proof cannot fall back | mitigated by the #392 typed consumer; combined reputation output remains gated on #391 |
