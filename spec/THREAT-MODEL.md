...
| IdentityBundle digest encoding substitution across agreement and terminal records | malicious counterparty / incompatible implementation | CORE §B.2 IBH-1..IBH-6 (one bare-lowercase current wire form; independently recomputed bundle digest; typed legacy-agreement reader only; no pre-verification normalisation; role/claim-bound terminal projection) | mitigated; permitted legacy agreements retain their original signed bytes and commitment |
