...
| Fresh or backdated legacy agreement used after payee-binding activation to inject a runtime destination | malicious orchestrator / counterparty | §8.6 CA-10 + §9.5.1 LAA-1..LAA-7 (governed checkpoint on authenticated session substrate; checkpoint/commitment/evidence share one finality/genesis ordering domain; no in-flight exception; producer timestamps ignored) | mitigated for current readers; historical bytes remain audit-only |
